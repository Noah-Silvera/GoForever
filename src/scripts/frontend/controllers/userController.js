 define(['controllers/controller','views/userView','models/userModel','lib/request','requestHandler','lib/statistics'], function(Controller,UserView,UserModel,request,RequestHandler,Stats){
    ...
    class UserController extends Controller{
        ...
        signup(){  
            ...
            if (data.username.length == 0) alert("Must provide a username.");
                ...
                RequestHandler.signup(data)
                    .then(function(res){
                        window.location.href = 'roberts.seng.uvic.cauvic.ca:30103/userLanding.html'
                    })
                    .catch(function(err){
                        console.debug(err)
                    })   
        ...
        logout(){
            ...
            .then(function(res){
                console.log(res)
                window.location.href = 'roberts.seng.uvic.cauvic.ca:30103/'
            })
            .catch(function(err){
                console.log(err)
            })
        ...
        playGame(){
            ...
            window.location.href = 'roberts.seng.uvic.cauvic.ca:30103/gameOptions'
        }
        ...
        loadProfilePage(){
            window.location.href = 'roberts.seng.uvic.cauvic.ca:30103/userProfile.html'
        }

        loadSettingsPage(){
            // do user specific things here

            window.location.href = 'roberts.seng.uvic.cauvic.ca:30103/userSettings.html'
        }
