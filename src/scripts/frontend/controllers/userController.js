 define(['controllers/controller','views/userView','models/userModel','lib/request','requestHandler','lib/statistics'], function(Controller,UserView,UserModel,request,RequestHandler,Stats){
    ...
    class UserController extends Controller{
        ...
        logout(){
            ...
            .then(function(res){
                console.log(res)
                window.location.href = 'seng.roberts.uvic.ca:30103/'
            })
            .catch(function(err){
                console.log(err)
            })
        ...
        playGame(){
            ...
            window.location.href = 'seng.roberts.uvic.ca:30103/gameOptions'
        }
        ...
        loadProfilePage(){
            window.location.href = 'seng.roberts.uvic.ca:30103/userProfile.html'
        }

        loadSettingsPage(){
            // do user specific things here

            window.location.href = 'seng.roberts.uvic.ca:30103/userSettings.html'
        }
