 define(['controllers/controller','views/userView','models/userModel','lib/request','requestHandler','lib/statistics'], function(Controller,UserView,UserModel,request,RequestHandler,Stats){
    ...
    class UserController extends Controller{
        ...
        signup(){  
            ...
            if (data.username.length == 0) alert("Must provide a username.");
                ...
                RequestHandler.signup(data)
                    .then(function(res){
                        window.location.href = 'http://roberts.seng.uvic.ca:30128/userLanding.html'
                    })
                    .catch(function(err){
                        console.debug(err)
                    })   
        ...
        logout(){
            ...
            .then(function(res){
                console.log(res)
                window.location.href = 'http://roberts.seng.uvic.ca:30128/'
            })
            .catch(function(err){
                console.log(err)
            })
        ...
        playGame(){
            ...
            window.location.href = 'http://roberts.seng.uvic.ca:30128/gameOptions'
        }
        ...
        loadSettingsPage(){
            ...
            window.location.href = 'http://roberts.seng.uvic.ca:30128/userSettings.html'
        }
